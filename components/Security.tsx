        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-slate-600 text-lg leading-relaxed">
              In Deutschland ansässige Unternehmen fordern höchste Standards. Blue ChatBot bietet Architektur-Optionen, die über Standard-SaaS weit hinausgehen.
            </p>
            
            <div className="space-y-6 mt-4">
              {[
                { icon: 'shield_lock', title: '100% DSGVO-Compliance', desc: 'Die gesamte Datenverarbeitung findet auf Servern in der EU nach strikten Richtlinien statt.' },
                { icon: 'lan', title: 'Hybrid & On-Premise fähig', desc: 'Für maximale Kontrolle hosten wir Ihren ChatBot auf Ihrer eigenen Infrastruktur – ohne Datenabfluss.' },
                { icon: 'lock_person', title: 'Kein Modell-Training mit Ihren Daten', desc: 'Ihre Geschäftsgeheimnisse bleiben sicher. Wir nutzen Ihre Kundenchats nicht für das Training öffentlicher Modelle.' },
              ].map((item, i) => (
          ...
          <div className="relative">
            ...
            <div className="relative bg-slate-950 rounded-[2.5rem] p-10 shadow-2xl border border-slate-800 h-[500px] flex flex-col justify-between overflow-hidden group">
              ...
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="text-[10px] font-mono text-slate-500 uppercase tracking-widest">Security Monitor v4.0.1</div>
              </div>
              ...
              <div className="flex-1 font-mono text-sm space-y-4">
                ...
                <div className="mt-8 pt-8 border-t border-slate-800">
                  <div className="text-xs text-slate-500 mb-2 uppercase tracking-widest">Aktive Schutzmechanismen:</div>
                  <div className="grid grid-cols-1 gap-2">
                    <div className="flex items-center gap-2 text-blue-400/80">
                      <span className="material-symbols-outlined !text-xs">check_circle</span>
                      <span>Zero-Trust Architektur</span>
                    </div>
                    <div className="flex items-center gap-2 text-blue-400/80">
                      <span className="material-symbols-outlined !text-xs">check_circle</span>
                    ...
                    <div className="flex items-center gap-2 text-blue-400/80">
                      <span className="material-symbols-outlined !text-xs">check_circle</span>
                      <span>DSGVO Daten-Anonymisierung</span>
                    </div>
                  </div>
                </div>
              </div>
